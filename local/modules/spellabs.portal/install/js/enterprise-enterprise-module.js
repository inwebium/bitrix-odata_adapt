...
var EnterpriseBirthdaysInformerComponent = /** @class */ (function () {
    ...
    EnterpriseBirthdaysInformerComponent.prototype.load = function () {
        ...
        this.employeesFactory.getPagedByMonthBirthday(month).subscribe(function (birthdays) {
            if (birthdays.items.length !== 0 && birthdays.items[0].birthdayDay - start < 3) {
...
var EnterprisePageComponent = /** @class */ (function () {
    function EnterprisePageComponent(route, sidebarService, companiesService) {
        this.route = route;
...
var IncidentsInformerComponent = /** @class */ (function () {
    ...
    IncidentsInformerComponent.prototype.openModal = function () {
        this.modalIsOpen = true;
    };
    IncidentsInformerComponent.prototype.getIncident = function () {
        var _this = this;
        this.incidentsService
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (incidents) { return incidents[0]; })).subscribe(function (item) {
            _this.incident = item;
            if (_this.incident) {
                var incidentDate = moment__WEBPACK_IMPORTED_MODULE_3__(_this.incident.date, 'YYYY-MM-DD');
...
var IncidentsInformerResolver = /** @class */ (function () {
    function IncidentsInformerResolver(incidentsService) {
        this.incidentsService = incidentsService;
    }

...
module.exports = "<ng-container *ngIf=\"!loading\">\n  <div class=\"m-birthday\" [class.no-elements]=\"employees && !employees.length\">\n    <div class=\"m-birthday__item\" *ngFor=\"let item of employees\" [class.is-disable]=\"item.birthdayDay !== currentDay\">\n      <div class=\"inner\">\n        <div class=\"avatar\">\n          <div class=\"thumb\">\n            <div class=\"content\">\n              <app-user-thumb [photo]=\"item.photo\" [height]=\"'100%'\" [width]=\"'100%'\" [route]=\"item.profileRoute\"\n                [active]=\"item.reason == null || item.reason === ''\"></app-user-thumb>\n            </div>\n          </div>\n        </div>\n        <div class=\"info\">\n          <div class=\"date\">{{ item.birthdayTitle }}</div>\n          <div class=\"name\">{{ item.fullName }}</div>\n          <div class=\"position\">{{ item.positionName }}</div>\n        </div>\n      </div>\n    </div>\n    <div class=\"info-block\" *ngIf=\"!threeDays\">\n      Ближайших дней рождения нет\n    </div>\n  </div>\n</ng-container>\n<ng-container *ngIf=\"loading\">\n  <div class=\"skeleton-birthday\">\n    <div class=\"skeleton-birthday-item\" *ngFor=\"let item of getArray(3)\">\n      <div class=\"inner\">\n        <div class=\"skeleton-avatar\">\n          <div class=\"skeleton-thumb skeleton-animation\"></div>\n        </div>\n        <div class=\"skeleton-info\">\n          <div class=\"skeleton-lines\">\n            <div class=\"skeleton-line\"></div>\n            <div class=\"skeleton-line\"></div>\n            <div class=\"skeleton-line\"></div>\n            <div class=\"skeleton-line\"></div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</ng-container>"
...
var EnterpriseBirthdaysInformerComponent = /** @class */ (function () {
    ...
    EnterpriseBirthdaysInformerComponent.prototype.getArray = function (i) {
        return new Array(i);
    };
...
var EnterpriseNewsInformerComponent = /** @class */ (function () {
    ...
    EnterpriseNewsInformerComponent.prototype.getArray = function (i) {
        return new Array(i);
    };

...
var SearchResultsPageComponent = /** @class */ (function () {
    function SearchResultsPageComponent(route, sharepointService, searchService, zone, router) {
        this.route = route;
        ...
        this.hasPrev = false;
        this.hasNext = false;
        this.loading = true; // признак состояния - "идет загрузка"
        this.pages = [];
        this.index = null;
    ...
    SearchResultsPageComponent.prototype.ngOnInit = function () {
        ...
        this.keywordSubscription = this.route.params
            ...
            _this.type = _this.getSearchTypeByTypename(type);
        });
    ...
    SearchResultsPageComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        console.log('ngAfterViewInit - search-results-page.component.ts');
        this.search(_services_search_search_service__WEBPACK_IMPORTED_MODULE_4__["SearchType"].Simple); // инициируем поиск  при первом отображении
    ...
    SearchResultsPageComponent.prototype.getSearchTypeByTypename = function (type) {
        switch (type) {
            case 'documents':
                {
                    return _services_search_search_service__WEBPACK_IMPORTED_MODULE_4__["SearchType"].Documents;
                }
            case 'news':
                {
                    return _services_search_search_service__WEBPACK_IMPORTED_MODULE_4__["SearchType"].News;
                }
            case 'people':
                {
                    return _services_search_search_service__WEBPACK_IMPORTED_MODULE_4__["SearchType"].People;
                }
            case 'requests':
                {
                    return _services_search_search_service__WEBPACK_IMPORTED_MODULE_4__["SearchType"].Requests;
                }
            default:
                {
                    return _services_search_search_service__WEBPACK_IMPORTED_MODULE_4__["SearchType"].Simple;
                }
        }
    };
    ...
    SearchResultsPageComponent.prototype.formatDescription = function (result) {
        return this.searchService.getDescription(result);
    };
    SearchResultsPageComponent.prototype.formatTitle = function (result) {
...
var SearchService = /** @class */ (function () {
    ...
    SearchService.prototype.getTitle = function (item) {
        var result = item.HitHighlightedProperties || item.Title;
        var regexp = /<HHTitle>[^]*?<\/HHTitle>/gi;
        var matches = result.match(regexp);
        if (matches.length > 0) {
            result = matches[0].replace(/<HHTitle>/gi, '')
                .replace(/<\/HHTitle>/gi, '')
                .replace(/c0/gi, 'strong').replace(/<ddd\/>/gi, '&#8230;');
        }
        return result;
    };
    SearchService.prototype.getDescription = function (result) {

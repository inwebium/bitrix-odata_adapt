...
var BookingMasterPageComponent = /** @class */ (function () {
    function BookingMasterPageComponent(route) {
        this.route = route;
        this.webId = undefined;
        this.pickedRoom = null;
...
var BookingMasterStepOneComponent = /** @class */ (function () {
    function BookingMasterStepOneComponent(roomsService, reservationsService) {
    ...
    BookingMasterStepOneComponent.prototype.prepareLink = function (link) {
        return this.prepareBackgroundUrl(link);
    };
    BookingMasterStepOneComponent.prototype.prepareBackgroundUrl = function (link) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], BookingMasterStepOneComponent.prototype, "webId", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
...
/* harmony import */ var src_app_booking_services_reservations_mail_reservations_mail_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/booking/services/reservations-mail/reservations-mail.service */ "./src/app/booking/services/reservations-mail/reservations-mail.service.ts");
...
var BookingMasterStepTwoComponent = /** @class */ (function () {
    function BookingMasterStepTwoComponent(sharepointService, reservationsService, meetingTypesService, reservationsMailService) {
    ...
    BookingMasterStepTwoComponent.prototype.createReservation = function (item) {
        var _this = this;
        item.roomLookupTitle = this.pickedRoom.title;
        if (!this.reservation.title) {
            ...
            this.reservation.eventDate = moment__WEBPACK_IMPORTED_MODULE_5__(date + ' ' + this.timeStart, 'DD.MM.YYYY HH:mm').toISOString();
            this.reservation.endDate = moment__WEBPACK_IMPORTED_MODULE_5__(date + ' ' + this.timeEnd, 'DD.MM.YYYY HH:mm').toISOString();
    ...
    BookingMasterStepTwoComponent.prototype.prepareLink = function (link) {
        return this.prepareBackgroundUrl(link);
    };
    BookingMasterStepTwoComponent.prototype.prepareBackgroundUrl = function (link) {
        return link && link.replace(/\(/gi, '\\(').replace(/\)/gi, '\\)').replace(/'/gi, '%27') || null;
    };
    BookingMasterStepTwoComponent.prototype.ngOnInit = function () {
        ...
        this.date = moment__WEBPACK_IMPORTED_MODULE_5__(this.pickedDay.date).format('DD MMMM');
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], BookingMasterStepTwoComponent.prototype, "webId", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ...
    BookingMasterStepTwoComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_sharepoint_sharepoint_service__WEBPACK_IMPORTED_MODULE_3__["SharepointService"],
            ...
            src_app_booking_services_reservations_mail_reservations_mail_service__WEBPACK_IMPORTED_MODULE_4__["ReservationsMailService"]])
                ...
                if (data.list !== undefined) {
                    for (var _i = 0, _a = data.list; _i < _a.length; _i++) {
                        ...
                        if ((formatedReservationStart >= tempEventStart) &&
                            ...
                            if ((_this.editableReservation.id !== reservation.id) || _this.isDublicateItem) {
                                valid_1 = false;
    ...
    BookingModalFormComponent.prototype.updateReservation = function (item) {
        ...
        if (timeStart >= timeEnd) {
            ...
            this.reservationsService.updateItem({
                ...
                else if (moment__WEBPACK_IMPORTED_MODULE_3__(item.eventDate).toISOString() !== moment__WEBPACK_IMPORTED_MODULE_3__(oldReservation.eventDate).toISOString()) {
...
var MeetingRoomReservationPageComponent = /** @class */ (function () {
    function MeetingRoomReservationPageComponent(sharepointService, officesService, route, router, roomsService, reservationsService, meetingTypesService, reservationsMailService, securityService) {
        this.sharepointService = sharepointService;
        ...
        this.path = this.route.snapshot.paramMap.get('date');
        this.displayedDay = moment__WEBPACK_IMPORTED_MODULE_8__(this.path, 'DD-MM-YYYY');
    ...
    MeetingRoomReservationPageComponent.prototype.pickDate = function () {
        var _this = this;
        this.router.navigate(['/booking', this.corporationId, this.getRoutingDate()]);
    ...
    MeetingRoomReservationPageComponent.prototype.getRoutingDate = function () {
        return this.displayedDay.format('DD-MM-YYYY');
    };
    MeetingRoomReservationPageComponent.prototype.remove = function (item) {
        ...
        this.reservationsService.deleteItem(item, this.webId)
            ...
            // Без таймаута присылает по 3 одинаковых сообщения на почту
            setTimeout(function () { _this.reservationsMailService.removeNotify(_this.webId, item); }, 100);
        });
    };
    MeetingRoomReservationPageComponent.prototype.ngOnInit = function () {
        ...
        // TODO: иная реализация даты в url`e, исключить из ссылки на мастер бронирования дату
        this.displayedDay = moment__WEBPACK_IMPORTED_MODULE_8__();
        this.router.navigate(['/booking', this.corporationId, this.getRoutingDate()]);
...
var ReservationsMailService = /** @class */ (function () {
    ...
    ReservationsMailService.prototype.createNotify = function (webid, item) {
        ...
        var subject = 'Встреча';
        var body = 'Встреча запланирована на ' + eventDate + ', переговорная ' + item.roomLookupTitle;
        var recipients = '';

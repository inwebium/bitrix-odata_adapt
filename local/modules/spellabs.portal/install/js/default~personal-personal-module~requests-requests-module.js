...
var RequestsPageComponent = /** @class */ (function () {
    function RequestsPageComponent(requestsModalService, route) {
        this.requestsModalService = requestsModalService;
        this.route = route;
        this.countUndone = 0;
        this.countDone = 0;
